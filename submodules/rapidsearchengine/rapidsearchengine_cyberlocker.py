...
class RapidsearchengineCyberlockerSpider(scrapy.Spider):
    __domain = "rapid-search-engine.com"
    __protocol = "https"
    __baseURL = __protocol + "://" + __domain
    __write_dir = "debug"
    __write_filename = "rapidsearchengine_cyberlocker_url.txt"
    __read_filename = "debug/{0}/rapidsearchengine_url.txt"
    __timestamp = ""
    ...
    def __init__(self, search_term, licensor_name, time_stamp, **kwargs):
        ...
        super(RapidsearchengineCyberlockerSpider, self).__init__(**kwargs)
