...
class RapidsearchengineRequestSpider(scrapy.Spider):
    __domain = "www.filesloop.com"
    __protocol = "https"
    __baseURL = __protocol + "://" + __domain
    __driver = "rapidsearchengine"
    __write_dir = "debug"
    __write_filename = "rapidsearchengine_url.txt"
    __search_term = ""
    __licensor_name = ""
    ...
    def __init__(self, search_term, licensor_name, time_stamp, **kwargs):
        ...
        super(RapidsearchengineRequestSpider, self).__init__(**kwargs)
