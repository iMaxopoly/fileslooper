...
class SharedirCyberlockerSpider(scrapy.Spider):
    __domain = "sharedir.com"
    __protocol = "https"
    __baseURL = __protocol + "://" + __domain
    __write_dir = "debug"
    __write_filename = "sharedir_cyberlocker_url.txt"
    __read_filename = "debug/{0}/sharedir_url.txt"
    __timestamp = ""
    ...
    def __init__(self, search_term, licensor_name, time_stamp, **kwargs):
        ...
        super(SharedirCyberlockerSpider, self).__init__(**kwargs)
    ...
    def parse(self, response):
        ...
        cyberlocker_links = response.xpath("//pre[@id='dirlinks']/text()").extract_first()
