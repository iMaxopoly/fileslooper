...
class SoftarchiveRequestSpider(scrapy.Spider):
    __domain = "www.filesloop.com"
    __protocol = "https"
    __baseURL = __protocol + "://" + __domain
    __driver = "softarchive"
    __write_dir = "debug"
    __write_filename = "softarchive_url.txt"
    __search_term = ""
    __licensor_name = ""
    ...
    def __init__(self, search_term, licensor_name, time_stamp, **kwargs):
        ...
        super(SoftarchiveRequestSpider, self).__init__(**kwargs)
