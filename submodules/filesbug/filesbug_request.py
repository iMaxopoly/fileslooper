...
class FilesbugRequestSpider(scrapy.Spider):
    __domain = "www.filesloop.com"
    __protocol = "https"
    __baseURL = __protocol + "://" + __domain
    __driver = "filesbug"
    __write_dir = "debug"
    __write_filename = "filesbug_url.txt"
    __search_term = ""
    __licensor_name = ""
    ...
    def __init__(self, search_term, licensor_name, time_stamp, **kwargs):
        ...
        super(FilesbugRequestSpider, self).__init__(**kwargs)
    ...
    def parse(self, response):
        ...
        for f in files:
            ...
            if file_url is "" or self.__driver not in file_url:
                continue
